...
class InitialBudgetView: UIView {
    ...
    lazy var titleLabel = Label(textLabel: R.string.localizable.distributeBudgetLabel(), textSize: 24, weight: .medium)
    private lazy var inputSumLabel = Label(textLabel: R.string.localizable.inputBudgetLabel(), textSize: 16, weight: .medium)
    private lazy var setupCategoriesLabel = Label(textLabel: R.string.localizable.setupCategoryLabel(), textSize: 16, weight: .medium)
    ...
    private lazy var categoryStack = Stack(stackSpaicing: 20, views: [productsCategoryView, transportCategoryView,
