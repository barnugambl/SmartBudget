...
class AddFinancialGoalView: UIView {
    ...
    private lazy var titleLabel = Label(textLabel: R.string.localizable.addFinancialGoalLabel(), textSize: 24, weight: .medium)
    lazy var dateTextFieldLabel = Label(textLabel: "Дата окончания", textSize: 16, weight: .medium)
    ...
    private lazy var nameSumGoalStackView = Stack(stackSpaicing: 20, views: [nameGoalTextField, sumGoalTextField])
    private lazy var dateStackView = Stack(views: [dateTextFieldLabel, dateTextField])
