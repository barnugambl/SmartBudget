...
class LogView: UIView {
    ...
    private lazy var passwordTextField = TextField(fieldPlaceHodler: R.string.localizable.inputPasswordTextField(),
                                                   isPassword: true)
    
    private lazy var title = Label(textLabel: R.string.localizable.logLabel(), textSize: 20)
