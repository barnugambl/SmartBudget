...
class EditProfileView: UIView {
    ...
    private lazy var editNumberTextField = TextField(fieldPlaceHodler: "+7-XXX-XXX-XX-XX")
    
    private lazy var editPasswordLabel = Label(textLabel: R.string.localizable.editPasswordLabel(),
                                               textSize: 16)
    
    private lazy var editPasswordTextField = TextField(fieldPlaceHodler: "****",
                                                       isPassword: true)
    
    private lazy var confirmPasswordLabel = Label(textLabel: R.string.localizable.confirmNewPasswordLabel(),
                                                  textSize: 16)
    
    private lazy var confirmPasswordTextField = TextField(
